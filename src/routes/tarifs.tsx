  ...
  return (
    <>
      <PageIntro
        ...
        lead="Le remboursement dépend de l'affiliation du psychologue au parcours psy. Je n'y suis pas affiliée : mes séances ne sont donc pas prises en charge par la Sécurité sociale. Certaines mutuelles couvrent néanmoins tout ou partie des séances : renseignez-vous auprès de la vôtre."
      />
